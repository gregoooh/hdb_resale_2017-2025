...
\#Distance to MRT We will use the SF package for calculating the minimum
distance between a HDB and its respectivce coordinates. - CRS 4326 is
standard GPS lat/lon.
...
\#Distance to Shopping Center We will use the SF package for calculating
the minimum distance between a HDB and its respectivce coordinates. -
